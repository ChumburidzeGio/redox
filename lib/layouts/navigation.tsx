...
export const DropdownMenu: React.FC<DropdownMenuProps> = ({
  ...
  return (
    <div>
      ...
      <div
        className={classNames(folded ? "hidden" : "visible", "flex flex-col")}
      >
        {items.map((item) => (
  ...
  return (
    <>
      <nav className="flex flex-1 px-4 pb-4 pt-3 space-y-1 flex-col justify-between h-full">
        ...
        <div className="flex flex-col">
          <a
            className="group flex items-center px-2 py-2 text-md rounded-md cursor-pointer text-gray-500 hover:bg-gray-50 hover:text-gray-900"
