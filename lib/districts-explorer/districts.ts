const districts = [
    ...
    },
    {
        ...
        description:
            'One of the most desirable neighborhoods with fashionable shopping streets PC Hooftstraat, Van Baerlestraat and Beethovenstraat, famous museums, Coster Diamonds, Concertgebouw, and the Vondelpark.',
    },
    {
    ...
    },
    {
        ...
        tags: ['central', 'old buildings'],
        description:
            'Across the water from Centraal Station, Noord has been little more than a dull dormitory suburb up until now. However, this is changing with its Noorder Park, charming little villages, quiet dining options, and waterside hangouts with beautiful terraces.',
    },
    {
