                    ...
                    <Form onSubmit={(data) => mutation.mutate(data)} methods={methods}>
                        <div className="p-5">
                            ...
                            <Input
                                ...
                                rules={{ required: true }}
                            />
                            <ErrorText id="oldPassword">Please enter your old password</ErrorText>
                            ...
                            <ErrorText id="newPassword">Please enter a new password</ErrorText>
                        ...
                        <div className="px-4 py-3 bg-gray-50 text-right sm:px-6">
                            <Button variant="primary">
                                {mutation.isLoading ? '...' : ''} Updat{mutation.isLoading ? 'ing' : 'e'} Password
                            </Button>
                        </div>
                    </Form>
                    <Alert
