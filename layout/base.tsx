...
export const BaseLayout: React.FC<Props> = ({ children, navigation }) => {
            ...
            <div className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0">
                ...
                <div className="flex flex-col flex-grow border-r border-gray-200 pt-5 bg-white overflow-y-auto">
                    ...
                    <div className="mt-5 flex-grow flex flex-col">
                        <nav className="flex-1 px-4 pb-4 pt-3 space-y-1">
                            {navigation.map((item) => (
                                <a
                                    key={item.name}
                                    href={item.href}
                                    className={classNames(
                                        router.asPath === item.href ? 'bg-gray-100 text-black font-semibold' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900',
