...
const ImageCard: React.FC<ImageCardProps> = ({ imageSrc, mapQuery, videoId, children }) => {
    return (
...
const DistrictsExplorer: React.FC = () => {
        ...
        <div className="relative">
            ...
            {!expanded && (<div
                ...
                <div className="flex font-semibold items-center font-sm">
                    <ChevronDoubleDownIcon className="h-5 w-5 mr-2" /> SHOW ALL
                </div>
            </div>)}
        </div>
    )
