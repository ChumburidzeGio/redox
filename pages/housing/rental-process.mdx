...
With the first month's rent, you are also required to pay a deposit (Borg in Dutch) which is typically two months'rent for furnished apartments and one month's rent for unfurnished.
