...
<LogEvent name="redox:view" props={{ page: 'furnishing-apartment' }} />
...
Ikea can be a good choice also because of their delivery service. However, if you bought your furniture from a place which does not provide you delivery, you could use expat-friendly delivery companies to move your furniture like [Brenger](https://www.brenger.nl/en-nl/) or prefer a more affordable one such as [Student Moving Service](https://www.studentverhuisservice.nl/).
