import { Youtube, Callout, LogEvent } from 'blocks'

<LogEvent name="redox:view" props={{ page: 'healthcare-system' }} />
...
There are many expat-friendly dental professionals, clinics, and practices around Amsterdam such as **Lassus Tandartsen, Tandarts Jordaan, and Tandartspraktijk Plantage**. To find your dentist, you can also ask your friends, neighbours, and your GP or visit [the website Tandarts.nl](https://www.tandarts.nl/tandarts-amsterdam)
