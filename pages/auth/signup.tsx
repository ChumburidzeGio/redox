                ...
                <div className="mt-3 text-center sm:mt-5">
                  ...
                  <div className="mt-2">
                    <p className="text-md text-gray-500">
                      Shortly you will receive an email with verification link
                      and instructions.
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 space-y-6">
              ...
              >
                ...
                <ErrorText id="password">
                  Please enter a password that has minimum 8 characters (min 1
                  uppercase letter, 1 lowercase and one number).
                </ErrorText>
