...
## The OV-chipkaart
The OV-chipkaart (OV stands for openbaar vervoer, or public transport) is the Dutch smart-card payment system that operates across the country for all public transport options. There are two types of OV-chipkaart: anonymous and personal. Anonymous cards can be bought and topped-up from GVB ticket machines and GBV ticket offices at train and metro stations. Personal cards can be bought online from Ov-Chipkaart official website, and you will need to provide a photo for the card. 

Wherever you are in the Netherlands, it is possible to use the OV-chipkaart for public transport. The most important tip for using your public transport chip card is to always remember to check in and check out. If you switch from travelling by train to, say, travelling by bus, remember to check out. This usually does not apply when you switch trains unless you change train companies. If you transfer to a regional train company, you will need to check out. For more information visit OV-Chipkaart official website. 
