...
## The OV-chipkaart
The OV-chipkaart (OV stands for openbaar vervoer, or public transport) is the Dutch smart-card payment system that operates across the country for all public transport options. There are two types of OV-chipkaart: anonymous and personal. Anonymous cards can be bought and topped-up from GVB ticket machines and GBV ticket offices at train and metro stations. Personal cards need to be bought online, and you will need to provide a photo for the card. 
