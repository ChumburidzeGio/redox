...
<Callout>
    Although using iDEAL is very handy, you should remember that it can be problematic when you need a refund. Because handling refunds is not part of the iDEAL scheme, contacting the seller about the refund would be your only option, while you can also reach your bank if you've paid with a credit card. 
</Callout>
