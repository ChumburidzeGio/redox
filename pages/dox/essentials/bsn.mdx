...
<callout type="warning">
    Keep in mind that the appointment date can be later than your arrival in the Netherlands due to overload work at the municipality and the IN Amsterdam.
</callout>
...
<callout type="warning">
    Non-resident BSN is a limited version of BSN and while it allows you to open a bank account or receive a salary, you won't be able to get the insurance with it for example.
</callout>
