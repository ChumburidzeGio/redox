<meta id="work" title="Taxes & Social Security" />
...
The 30% ruling is a tax advantage for expats working in the Netherlands, meaning that 30% of your salary won't be taxed. This ruling can be seen as compensation for your expenses as you are working outside your home country. To check eligibility for 30% ruling please check [Tax Administration's](https://www.belastingdienst.nl/wps/wcm/connect/en/individuals/content/coming-to-work-in-the-netherlands-30-percent-facility) website.

<callout>
    Keep in mind that once you apply to use the 30% ruling, it might take up to
    10 weeks until you hear the response.
</callout>
