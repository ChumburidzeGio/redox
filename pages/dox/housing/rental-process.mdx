...
<callout>
    We conduct a maximum of 8 viewings per relocation, but usually, 3-4 viewings
    are more than enough to make an offer. Please sit back, request viewings
    only on the apartments you like, and let us do the magic 🪄
</callout>
...
<callout>
    We generally request contracts with a diplomatic clause, so just in case you
    have to leave the country within a rental period, you can present proof and
    stop the rent after one or two months notice period.
</callout>
