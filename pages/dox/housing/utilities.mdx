...
In most cases, gas & electricity will already be available in your apartment, and you will have to transfer accounts to your name. However, the power is switched off when the previous occupants close their account. Therefore, it is crucial to arrange gas and electricity in your new apartment quickly. Note the meter reading and notify the energy supplier if you don't want to change the current energy provider in the apartment. 
...
## Water
Most accommodation is already connected to the water supply of the drinking water provider. Although you can choose your energy provider, you cannot choose your water supplier. Each city has its provider - in Amsterdam, Waternet - you can register on [their website](https://www.waternet.nl/en/service-and-contact/moving-home/register/#/). The water can be used immediately and the water meter in your apartment measures consumption. 

## Internet
Many Internet providers in the Netherlands offer Internet via cable, ADSL/VDSL, and fiber optics, which may be determined by where you live. Signing up is easy and usually done online or via the phone. Prices vary depending on the provider and what package you go for; generally, the faster the Internet, the higher the cost. To compare all the Internet providers, you can visit [here](https://www.prijsvergelijken.nl/compare-broadband/?utm_source=iamanexpatt).

## Mobile Phone
You can choose between a contract (Abonnementen) or a prepaid card. 

Prepaid card providers offer cheap packages including the option to keep the same number without charge. On the other hand, it would be wiser to sign a contract if you use your phone for national calls. You can compare the mobile phone provider on this [website](https://www.prijsvergelijken.nl/en_GB//telefoon-abonnement/).
