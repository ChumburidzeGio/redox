...
For **Amsterdam and Amstelveen** check an [interactive map](https://onderzoek.amsterdam.nl/interactief/dashboard-veiligheid) for crime rates. For **Almere** check [Neighbourhood Monitor](https://wijkmonitoralmere.nl/nl/start.html) for in-depth overview of each hood, including crime rates (*"Aantal misdrijven per 1000 inwoners"*).
