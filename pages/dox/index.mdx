...
<LogEvent name="redox:view" props={{ page: 'home' }} />

# Getting started
Welcome to Redox, it's our wiki where you will find all the information you will need on the way to Amsterdam.

<Callout>
    20th of January we will release a new version of Redox, which will include infromation about DigiD and MyGovernment, transportation and the new Integration module.
</Callout>
...
Let's start our journey by exploring Amsterdam, and it's neighbourhoods and reading about the housing process.
