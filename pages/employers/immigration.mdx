<meta id="employer-immigration" title="Immigration" />
...
One of the requirements for the highly skilled migrant procedure is that your company holds a recognised sponsorship with the [IND](http://www.ind.nl/) (Dutch Immigration Authorities) and is added to the [Public Register](https://ind.nl/en/Pages/public-register-recognised-sponsors.aspx) for Recognised Sponsors.

If your own company is not (yet) a recognised sponsor you can opt to work with an employer of record (payroll/umbrella companies). In this case, this is the formal employer of your new employee. After a successful application your employee can change employer so that she/he is on contract with your company directly.
