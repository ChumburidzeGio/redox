import {Callout, Image, LogEvent} from 'blocks'

<LogEvent name="redox:view" props={{ page: 'public-transportation' }} />
...
**Train** - The main public transport in the Netherlands for longer distances is by train. The train network operated by **NS (Nederlandse Spoorwegen)** covers much of the country, but other train companies operate as well.
