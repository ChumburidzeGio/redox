...
## New Car
Naturally, buying a new car is more costly than using a second-hand car. Also, the first owner of a new car must pay the **BPM tax** (Bijzondere Verbruiksbelasting van Personenauto’s) to register the car in their name. That makes a new car more expensive in the Netherlands. 

On the other hand, although costly, you’ll at least know what you’re getting with a new car. Everything from safety features to technology and maintenance checks will be up-to-date and fingers crossed it’ll serve you well for years to come.
