...
<Callout>
    Using iDEAL can be problematic when you need a refund. Because handling refunds is not part of the iDEAL scheme, contacting the seller about the refund would be your only option. However, if you've paid with a credit card, you can receive an immediate refund from your bank. 
</Callout>
